...
public class ItemsList : MonoBehaviour {
    ...
    void listOfItems()
    {
        ...
        item = new List<InventoryItems>()
        {
            ...
            new InventoryItems("Health Potion", "Potion that raises health by 10. Can be used in and out of combat.", 10, 0, 0, "healthpotion", 1),
            new InventoryItems("Life Potion", "Potion that is used to revive a fallen member", 1000, 0,1000,"healthpotion", 2),
            new InventoryItems("Apple", "Healthy snack :3", 5, 0, 0,"apple", 3),
